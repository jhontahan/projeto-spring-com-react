...
public class Lancamento {
	...
	@Override
	public int hashCode() {
		return Objects.hash(ano, dataCadastro, descriacao, id, mes, status, tipo, usuario, valor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(ano, other.ano) && Objects.equals(dataCadastro, other.dataCadastro)
				&& Objects.equals(descriacao, other.descriacao) && Objects.equals(id, other.id)
	...
	public String toString() {
		return "Lancamento [id=" + id + ", descriacao=" + descriacao + ", mes=" + mes + ", ano=" + ano + ", usuario="
